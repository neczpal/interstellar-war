...
struct RoomData {
    ...
    init(mRoomId: Int, mMapName: String, mUsers: [String], mMaxUserCount: Int, mIsRunning: Bool) {
        self.mRoomId = mRoomId
        self.mMapName = mMapName
        self.mUsers = mUsers
        self.mMaxUserCount = mMaxUserCount
        self.mIsRunning = mIsRunning
    }
