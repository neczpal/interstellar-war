//
//  InterstellarWarCommandParamKey.swift
//  InterstellarWar
//
//  Created by Neczpál Ábel on 2020. 01. 31..
...
class InterstellarWarCommandParamKey {
    ...
    public static let SPACESHIPS_KEY = "spaceships";
    
    public static let MAP_NAME_KEY = "map-name";
    public static let MAP_MAX_USER_COUNT_KEY = "map-max-user-count";
