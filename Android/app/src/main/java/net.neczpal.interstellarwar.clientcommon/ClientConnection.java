...
public class ClientConnection extends Thread {
	 ...
	 */
	public ClientConnection (String adresse, String userName) throws IOException, JSONException {
	 ...
	 */
	public void stopClientConnection () throws JSONException {
		mIsRunning = false;
		exitServer ();
		try {
			mSocket.close ();
	 ...
	 */
	private void loadMap (int roomIndex, JSONObject mapData) throws JSONException {
	 ...
	 */
	public void receive (JSONObject command) throws JSONException {
	 ...
	 */
	public void enterServer () throws JSONException {
	 ...
	 * Verlasst dem Server
	 */
	public void exitServer () throws JSONException {
		send (EXIT_SERVER);
		mLogger.log (Level.INFO, "<- Exiting server");
	}

	public void fillRoomWithAi ()  throws JSONException {
	 ...
	 */
	public void enterRoom (int roomId) throws JSONException {
		JSONObject command = new JSONObject ();
	 ...
	 */
	public void startRoom () throws JSONException {
		send (START_ROOM);
	 ...
	 */
	public void send (String type) throws JSONException {
		JSONObject command = new JSONObject ();
	 ...
	 * @param command Der Befehl
	 */
	public void send (JSONObject command) throws JSONException {
